...
// index.css, both themes). Clamped past the ramp. The hover:* variant pins the
// band on hover — otherwise TableRow's default hover:bg-muted/50 would wipe it,
// which reads as the section "flashing" as you move over it.
// See FRONTEND_CONVENTIONS.md §22.
const GRUPO_BG = [
  'bg-grupo-0 hover:bg-grupo-0',
  'bg-grupo-1 hover:bg-grupo-1',
  'bg-grupo-2 hover:bg-grupo-2',
  'bg-grupo-3 hover:bg-grupo-3',
];
