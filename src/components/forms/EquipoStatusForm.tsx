...
const EquipoStatusForm = ({
  equipo,
  onClose,
  onSuccess,
}: EquipoStatusFormProps) => {
  const [selectedStatus, setSelectedStatus] = useState<EstadoEquipo>(
    equipo?.estado || 'en_operacion',
  );
  ...
  const getEstadoInfo = (estado: EstadoEquipo): EstadoInfo => {
    return (
      estadosDisponibles.find((e) => e.value === estado) ||
          ...
          <div>
            ...
            <select
              ...
              onChange={(e: ChangeEvent<HTMLSelectElement>) =>
                setSelectedStatus(e.target.value as EstadoEquipo)
              }
              required
            >
