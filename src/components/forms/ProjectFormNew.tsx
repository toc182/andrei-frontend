...
const ProjectFormNew = ({
    ...
    const handlePartnerChange = (index: number, field: keyof Socio, value: string) => {
    ...
    const handleSubmit = async (data: ProjectFormData) => {
        try {
            ...
            const datosAdicionales = submitData.datos_adicionales as Record<string, unknown>;
            ...
            setError(apiError.response?.data?.message || 'Error de conexión al guardar el proyecto');
        } finally {
            setLoading(false);
        }
    };
