...
type DocumentType = 'acuerdo-consorcio' | 'carta-adhesion' | 'medidas-retorsion' | 'no-incapacidad' | 'pacto-integridad' | 'carta-compromiso-verde';
              ...
              <div key={field.name} className="space-y-2">
                ...
                {field.type === 'date' ? (
                  ...
                  <Textarea
                    ...
                    name={field.name}
                    value={formData[field.name] || ''}
                    onChange={(e: ChangeEvent<HTMLTextAreaElement>) => handleInputChange(field.name, e.target.value)}
