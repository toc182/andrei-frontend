...
export function ChangePasswordModal({ open, onOpenChange, forced = false }: ChangePasswordModalProps) {
      ...
      >
        ...
        {success ? (
          <div className="flex flex-col items-center gap-3 py-6">
            ...
            <p className="text-base font-medium text-green-700">Contraseña cambiada exitosamente</p>
          </div>
        ) : (
